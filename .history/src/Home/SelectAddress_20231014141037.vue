<template>
  <div class="SelectAdress">
    ...
    >
      ...
      <option v-for="City in CitiesData" v-bind:key="City">{{ City }}</option>
    </select>
    ...
    >
      ...
      <option v-for="District in DistrictsData" v-bind:key="District">
        {{ District }}
      </option>
    </select>
    ...
    >
      ...
      <option v-for="Ward in WardsData" v-bind:key="Ward">{{ Ward }}</option>
    </select>
