<template>
  <div class="SelectAdress">
    ...
    >
      ...
      <option v-for="(City, index) in CitiesData[SelectCity]" :key="index" :value="City">
        {{ City }}
      </option>
    </select>
    ...
    >
      ...
      <option
        v-for="(District, index) in DistrictsData[SelectDistrict]"
        :key="index"
        :value="District"
      >
        {{ District }}
    ...
    >
      ...
      <option v-for="(Ward, index) in WardsData[SelectWard]" :key="index" :value="Ward">
        {{ Ward }}
      </option>
    </select>
