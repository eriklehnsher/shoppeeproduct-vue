<template>
  <div class="group__input-data">
    <b-form-group class="" id="address" label-for="address">
      ...
      <select v-model="address.city" aria-placeholder="choose city" >
      ...
      <select v-model="address.district" aria-placeholder="choose distrct" required>
        <!-- inline object literal -->
        <option
      ...
      <select v-model="address.ward" aria-placeholder="choose wards" required>
        <!-- inline object literal -->
        <option
...
export default {
  data() {
    return {
      ...
      cities: ["Hà Nội"],
      districts: ["Hai Bà Trưng", "Ba Đình", "Bắc Từ Liên"],
      wards: {
        "hai ba trung": [
          "Bách Khoa",
          "Bạch Mai",
