<template>
  <div class="group__input-data">
    <b-form-group class="" id="address" label-for="address">
      ...
      <select v-model="selected" aria-placeholder="choose city" disabled>
      ...
      <select v-model="selected" aria-placeholder="choose distrct" required>
        <!-- inline object literal -->
        <option
      ...
      <select v-model="selected" aria-placeholder="choose wards" required>
        <!-- inline object literal -->
        <option
