                ...
                <div class="stars">
                  <div>
                    <div
                      v-for="i in maxStars"
                      :key="i"
                      @click="selectRating(font-awesome-icon)"
                      @mouseover="hoverrating(font-awesome-icon)"
                      @mouseleave="resetHover"
                      class="star"
                    >
                      <font-awesome-icon :icon="['fas', 'star',  { 'filled': i <= currentRating, 'hovered': i <= hoverRating }] " />
                    </div>
                  </div>
                </div>
              </div>
