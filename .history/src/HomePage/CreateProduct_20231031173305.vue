      ...
      >
        <div class="container-grid">
          <div class="grid-item mb-3">
           ...
           <div class="grid-item mb-3">
            <label for="product_name" class="form-label">Giá sản phẩm:</label>
            <input
              type="text"
              id="product_name"
  ...
  data() {
    return {
      form: {
        ...
        username_reviews: "",
        product_description: "",
        // images: "", // Sử dụng để lưu các tệp hình ảnh đã chọn
      },
      list: [],
    ...
    //   this.form.images = this.list;
      axios
        ...
        .then((response) => {
          ...
          this.$emit("newProductData", response);
