...
export default {
  ...
  if (this.list[i] && this.list[i].src) {
  // Truy cập thuộc tính 'src' chỉ khi đối tượng tồn tại và có 'src'
  console.log(this.list[i].src);
} else {
  console.log("Đối tượng không tồn tại hoặc không có thuộc tính 'src'");
}
  },
};
</script>
