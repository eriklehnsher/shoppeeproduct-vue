<template>
  <div class="homepage">
        ...
        <div class="banner-flex">
          ...
          <div class="main__productDetail">
            <h1 class="main__productName">
              ...
              (Type-C to HDMI/ USB3.0/ LAN/ Card Reader/ Type-C PD 100W)
            </h1>
    ...
    <div  class="product__historyPrice container">
      <div id="product-history-price-section_navigation" class="body__productHistoryPrice">
        <div class="line2"></div>
        <div
        ...
        <div class="d-flex flex-row justify-content-between">
          <div class="chart"></div>
          <div class="sumary">
            <div class="sumary1">asdas</div>
            <div class="sumary1">sdasdasd</div>
          </div>
        </div>
      </div>
